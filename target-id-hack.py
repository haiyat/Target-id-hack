...
\033[1;91mattack\033[1;97m>>\033[1;92m ''')
...
\033[1;91m<═══\033[1;41m\033[1;97m Created by HAIYAT MAHMUD\033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;91m[\033[1;97m?\033[1;91m]\033[1;92m Features Of attack:
...
\033[1;97m➤ \033[1;92mTool attack is created by haiyat_mahmud
\033[1;92m""")
...
\033[1;97m[\033[1;91m??\033[1;97m] \033[1;91mattack>> \033[1;92m"""
...
# main script start
os.system("xdg-open https://youtube.com/@shifatbondokshi")
time.sleep(5)
...
while True:
	...
	if menu == '01' or menu == '1':
		...
		print(banr)
		print()
		print("\033[1;91m[\033[;1;97m~\033[1;91m] \033[1;92mThanks for using my tool 'attack'. You can follow me on various social media site. Link and options are given down below, So select here options where you want to follow me ")
		print()
		print()
		while True:
			fol = input(soc)
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://github.com/haiyat")

			elif fol == '4' or fol == '04':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my facebook id in your device \n")
				time.sleep(1)
				os.system("xdg-open https://facebook.com/haiyat01601162005")
            
			elif fol == '5' or fol == '05':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Telegram Channel in your device \n")
				time.sleep(1)
				os.system("xdg-open https://t.me/haiyatmahmud")
